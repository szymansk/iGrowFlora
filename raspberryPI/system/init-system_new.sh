...
#sudo docker run -d --restart unless-stopped  --net=host --cap-add SYS_RAWIO --device /dev/mem --privileged -p 1880:1880  -v ~/node-red-data:/data  --name nodered/node-red-docker:rpi-alexa
sudo docker run -d --restart unless-stopped  --net=host --cap-add SYS_RAWIO --device /dev/mem --privileged -p 1880:1880  -v ~/node-red-data:/data  --name nodered/node-red-docker:rpi-alexa

#sudo docker run -d --restart unless-stopped  --net=host --cap-add SYS_RAWIO --device /dev/mem --privileged -p 1880:1880  -v ~/node-red-data:/data  --name mynodered mynodered:noderedIGrowFlora 
